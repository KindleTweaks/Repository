...
# Download and install Zen UI plugin
curl -fSL --progress-bar -o "$TMPDIR/zen_ui.koplugin.zip" \
  https://github.com/AnthonyGress/zen_ui.koplugin/releases/latest/download/zen_ui.koplugin.zip
unzip -o "$TMPDIR/zen_ui.koplugin.zip" -d /mnt/us/koreader/plugins/

# Download Scriptlet
curl -fSL --progress-bar -o /mnt/us/documents/zen_koreader.sh https://kf.penguins184.xyz/ZenKOReader/assets/zen_koreader.sh
